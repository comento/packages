...
- (void)decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSNumber *)arg_identifier webViewIdentifier:(NSNumber *)arg_webViewIdentifier navigationResponse:(FWFWKNavigationResponseData *)arg_navigationResponse completion:(void (^)(FWFFWFWKNavigationResponsePolicyEnum, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
  ...
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_webViewIdentifier ?: [NSNull null], arg_navigationResponse ?: [NSNull null]] reply:^(id reply) {
    FWFWKNavigationResponsePolicyEnum output = [reply integerValue];
    completion(output, nil);
  }];
}
...
void FWFWKWebViewHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKWebViewHostApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.setSupportScrollbar"
        binaryMessenger:binaryMessenger
        codec:FWFWKWebViewHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setSupportScrollbarForWebViewWithIdentifier:support:error:)], @"FWFWKWebViewHostApi api (%@) doesn't respond to @selector(setSupportScrollbarForWebViewWithIdentifier:support:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_identifier = GetNullableObjectAtIndex(args, 0);
        NSNumber *arg_support = GetNullableObjectAtIndex(args, 1);
        FlutterError *error;
        [api setSupportScrollbarForWebViewWithIdentifier:arg_identifier support:arg_support error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.setSupportOverscroll"
        binaryMessenger:binaryMessenger
        codec:FWFWKWebViewHostApiGetCodec()];
    if (api) {
...
- (void)runJavaScriptAlertPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier message:(NSString *)arg_message frame:(FWFWKFrameInfoData *)arg_frame completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.webview_flutter_wkwebview.WKUIDelegateFlutterApi.runJavaScriptAlertPanel"
      binaryMessenger:self.binaryMessenger
      codec:FWFWKUIDelegateFlutterApiGetCodec()];
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_message ?: [NSNull null], arg_frame ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
- (void)runJavaScriptConfirmPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier message:(NSString *)arg_message frame:(FWFWKFrameInfoData *)arg_frame completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
...
- (void)runJavaScriptTextInputPanelForDelegateWithIdentifier:(NSNumber *)arg_identifier prompt:(NSString *)arg_prompt defaultText:(NSString *)arg_defaultText frame:(FWFWKFrameInfoData *)arg_frame completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.webview_flutter_wkwebview.WKUIDelegateFlutterApi.runJavaScriptTextInputPanel"
      binaryMessenger:self.binaryMessenger
      codec:FWFWKUIDelegateFlutterApiGetCodec()];
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_prompt ?: [NSNull null], arg_defaultText ?: [NSNull null], arg_frame ?: [NSNull null]] reply:^(id reply) {
...
void FWFUIScrollViewDelegateHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIScrollViewDelegateHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
...
- (void)scrollViewDidScrollWithIdentifier:(NSNumber *)arg_identifier UIScrollViewIdentifier:(NSNumber *)arg_uiScrollViewIdentifier x:(NSNumber *)arg_x y:(NSNumber *)arg_y completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
  ...
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_uiScrollViewIdentifier ?: [NSNull null], arg_x ?: [NSNull null], arg_y ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
