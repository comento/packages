...
- (void)decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSInteger)identifier webViewIdentifier:(NSInteger)webViewIdentifier navigationResponse:(FWFWKNavigationResponseData *)navigationResponse completion:(void (^)(FWFFWFWKNavigationResponsePolicyEnumBox *_Nullable, FlutterError *_Nullable))completion;
...
- (void)setSupportScrollbarForWebViewWithIdentifier:(NSInteger)identifier support:(BOOL)support error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setSupportOverscrollForWebViewWithIdentifier:(NSInteger)identifier support:(BOOL)support error:(FlutterError *_Nullable *_Nonnull)error;
