...
- (void)setDelegateForScrollViewWithIdentifier:(NSNumber *)identifier uiScrollViewDelegateIdentifier:(nullable NSNumber *)uiScrollViewDelegateIdentifier error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSNumber *)identifier webViewIdentifier:(NSNumber *)webViewIdentifier navigationResponse:(FWFWKNavigationResponseData *)navigationResponse completion:(void (^)(FWFFWFWKNavigationResponsePolicyEnum, FlutterError *_Nullable))completion;
...
- (void)runJavaScriptAlertPanelForDelegateWithIdentifier:(NSNumber *)identifier message:(NSString *)message frame:(FWFWKFrameInfoData *)frame completion:(void (^)(FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptConfirmPanel`.
- (void)runJavaScriptConfirmPanelForDelegateWithIdentifier:(NSNumber *)identifier message:(NSString *)message frame:(FWFWKFrameInfoData *)frame completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
/// Callback to Dart function `WKUIDelegate.runJavaScriptTextInputPanel`.
- (void)runJavaScriptTextInputPanelForDelegateWithIdentifier:(NSNumber *)identifier prompt:(NSString *)prompt defaultText:(NSString *)defaultText frame:(FWFWKFrameInfoData *)frame completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
@end
...
extern void FWFUIScrollViewDelegateHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIScrollViewDelegateHostApi> *_Nullable api);
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)scrollViewDidScrollWithIdentifier:(NSNumber *)identifier UIScrollViewIdentifier:(NSNumber *)uiScrollViewIdentifier x:(NSNumber *)x y:(NSNumber *)y completion:(void (^)(FlutterError *_Nullable))completion;
@end
