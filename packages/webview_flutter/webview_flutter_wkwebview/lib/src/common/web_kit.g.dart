...
class WKWebViewHostApi {
  ...
  Future<void> setSupportScrollbar(int arg_identifier, bool arg_support) async {
    const String channelName = 'dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.setSupportScrollbar';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
    ...
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_support]) as List<Object?>?;
    if (replyList == null) {
      throw _createConnectionError(channelName);
    } else if (replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setSupportOverscroll(int arg_identifier, bool arg_support) async {
    const String channelName = 'dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewHostApi.setSupportOverscroll';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
...
class NSUrlCredentialHostApi {
  ...
  Future<void> createWithUser(int arg_identifier, String arg_user, String arg_password, NSUrlCredentialPersistence arg_persistence) async {
    const String channelName = 'dev.flutter.pigeon.webview_flutter_wkwebview.NSUrlCredentialHostApi.createWithUser';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
